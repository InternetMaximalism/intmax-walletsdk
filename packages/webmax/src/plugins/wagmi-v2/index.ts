...
export type WalletnextParameters = {
...
walletnext.type = "walletnext";

export function walletnext(parameters: WalletnextParameters) {
	...
	return createConnector<Provider, Properties, StorageItem>((config) => {
		...
		return {
			id: `walletnext:${parameters.wallet.url}`,
			icon: parameters.wallet.iconUrl,
			name: parameters.wallet.name || "Walletnext",
			type: walletnext.type,
			async setup() {
